"""
This module contains an example of how the ``MultiAttentionStudent`` model can be trained on various
datasets.
...
# [!] Use this string to select one of the possible tasks/datasets from the dictionary below.
DATASET = 'rb-motifs'
DATASETS = {
    'rb-motifs': {
